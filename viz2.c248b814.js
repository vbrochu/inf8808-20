...
var svg = d3.select("#viz2").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")"); // get the data
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/viz2.js"], null)
//# sourceMappingURL=/viz2.c248b814.js.map