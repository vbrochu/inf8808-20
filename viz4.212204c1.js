...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/preprocess.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.buildDictNoms = buildDictNoms;
exports.buildDictFonctions = buildDictFonctions;
exports.buildDictFilmoId = buildDictFilmoId;
exports.buildDictCareer = buildDictCareer;
var FONCTIONS = {
  24: 'Acteur',
  25: 'Acteur',
  15: 'Acteur',
...
function buildDictFonctions(data) {
...
function buildDictFilmoId(data) {
  var dict_filmoId = {};
  data.forEach(function (e) {
    dict_filmoId[e.FilmoId] = {
      'titreOriginal': e.titreOriginal,
      'anneeSortie': parseInt(e.anneeSortie)
    };
  });
  return dict_filmoId;
...
function buildDictCareer(data, dict_filmoId, dict_fonctionId, dict_nomsId) {
  var dict_noms_car = {};
  var dict_filmo_participants = {};
  data.forEach(function (e) {
    var new_element_dc = {
      'film': dict_filmoId[e.filmoId],
      'fonctionCategory': FONCTIONS[e.fonctionId],
      'fonction': dict_fonctionId[e.fonctionId]
    };
    ...
    var annee_sortie = dict_filmoId[e.filmoId].anneeSortie;

    if (annee_sortie > 1984) {
      var new_participant = {
        'nom': dict_nomsId[e.nomId],
        'fonction': dict_fonctionId[e.fonctionId]
      };
      ...
      if (e.filmoId in dict_filmo_participants) {
        ...
        dict_filmo_participants[e.filmoId] = {
...
},{"d3-collection":"node_modules/d3-collection/src/index.js","d3-selection":"node_modules/d3-selection/src/index.js"}],"node_modules/d3-svg-legend/node_modules/d3-selection/src/namespaces.js":[function(require,module,exports) {
"use strict";
...
var _default = index;
exports.default = _default;
},{"d3-selection":"node_modules/d3-svg-legend/node_modules/d3-selection/index.js","d3-format":"node_modules/d3-svg-legend/node_modules/d3-format/index.js","d3-dispatch":"node_modules/d3-svg-legend/node_modules/d3-dispatch/index.js","d3-scale":"node_modules/d3-svg-legend/node_modules/d3-scale/index.js","d3-array":"node_modules/d3-svg-legend/node_modules/d3-array/index.js"}],"src/viz4.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.generateGMatrix = generateGMatrix;
exports.appendAxes = appendAxes;
exports.setCanvasSizeMatrix = setCanvasSizeMatrix;
...
exports.getContentsMatrix = getContentsMatrix;
...
var ROLES = ['Acteur', 'Production', 'Image', 'Scénario', 'Générique additionnel', 'Science', 'Direction artistique', 'Narration', 'Photographe de plateau', 'Son', 'Direction de production', 'Esthetique', 'Assistant réalisation', 'Documentaire/émission']; //nombre de noms représentés
...
function generateGMatrix(margin) {
  return d3.select('#viz4').select('.matrix-svg').append('g').attr('id', 'matrix-g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
}
/*
...
function setCanvasSizeMatrix(width, height) {
  d3.select('#viz4').select('svg').attr('width', width).attr('height', height);
}
/**
...
function setColorScale() {
  return d3.scaleOrdinal().domain(ROLES).range(COLORS.slice(0, ROLES.length));
}
/**
 * cree les rectangles
 *
...
function appendRects(data) {
  d3.select('#matrix-g').selectAll().data(data).enter().append('g').attr('class', 'matrix-rect').append('rect');
}
/**
 * cree les rectangles
 *
...
function appendCircles(data, tip, dict_radiusScale) {
  function handleMouseOver(c, d) {
    if (c[MODE].count > 0) {
      tip.show(c, d);
      d3.select(d).attr("r", function (c) {
        return dict_radiusScale[MODE](c[MODE].count) + 2;
      });
    }
  }
  ...
  function handleMouseOut(c, d) {
    if (c[MODE].count > 0) {
      tip.hide();
      d3.select(d).attr("r", function (c) {
        return dict_radiusScale[MODE](c[MODE].count);
      });
    }
  }

  d3.select('#matrix-g').selectAll().data(data).enter().append('g').attr('class', 'matrix-circle').append('circle').on("mouseover", function (c) {
...
function updateXScale(xScale, roles, width) {
  xScale.domain(roles).range([0, width]);
}
/**
...
function updateYScale(yScale, noms, height) {
  yScale.domain(noms).range([0, height]);
}
/**
...
function drawXAxis(xScale) {
  d3.select('#viz4 .x.axis').attr('transform', 'translate(0, -10)').call(d3.axisTop().scale(xScale)).select('.domain').remove();
}
/**
...
function drawYAxis(yScale, width) {
  d3.select('#viz4 .y.axis').attr('transform', 'translate(' + width + ',0)').call(d3.axisRight().scale(yScale)).select('.domain').remove();
}
/**
...
function rotateXTicks() {
  d3.select('#viz4 .x.axis').selectAll('.tick text').attr('transform', 'rotate(-25)');
}
/**
...
function setRadiusScale(data, mode, cote_case_x, cote_case_y) {
  var maxCount = 0;
  data.forEach(function (e) {
...
function updateMatrix(xScale, yScale, colorScale, radiusScale, height, width) {
  var cote_case_x = width / ROLES.length;
  var cote_case_y = height / NB_NOMS;
  ...
  d3.select('#matrix-g').selectAll('.matrix-rect rect').attr('x', function (c) {
    return xScale(c[MODE].fonction);
  }).attr('y', function (c) {
    return yScale(c[MODE].nom);
  }).attr('width', cote_case_x).attr('height', cote_case_y).attr('fill', "white").attr("stroke", "black").attr("stroke-width", 1);
  d3.select('#matrix-g').selectAll('.matrix-circle circle').attr('cx', function (c) {
    return xScale(c[MODE].fonction) + cote_case_x / 2;
  }).attr('cy', function (c) {
    return yScale(c[MODE].nom) + cote_case_y / 2;
  }).attr("r", function (c) {
    return radiusScale(c[MODE].count);
  }).attr('fill', setColor);
}
/**
...
(function (d3) {
  ...
  var tipMatrix = (0, _d3Tip.default)().attr('class', 'd3-tip').html(function (d) {
    return getContentsMatrix(d);
  });
  d3.select('.matrix-svg').call(tipMatrix);
  var colorScale; //radius scale selon le mode courant

  var dict_radiusScale = {}; //associe nomId aux noms et prénoms

  var dict_nomsId; //associe fonction id au terme de la fonction
  ...
  Promise.all([d3.csv('./Nom.csv'), d3.csv('./Fonction.csv'), d3.csv('./Filmo.csv'), d3.csv('./Filmo_Generique.csv')]).then(function (fichiers) {
    ...
    dict_noms_car = aux[0];
    var g = generateGMatrix(margin_matrix);
    appendAxes(g); //on construit un dict associant nom_id à {nbre de participations , nb de rôles différents effectués}

    var dict_matrix = {};
    Object.keys(dict_noms_car).forEach(function (nomId) {
      var data_career = dict_noms_car[nomId]; //on compte le nombre de rôles différents
      ...
      var roles = Array.from(set_roles);
      var nb_roles = roles.length;
      var nb_part = data_career.length;
      dict_matrix[nomId] = {
        'nb_part': nb_part,
        'nb_roles': nb_roles
      };
    ...
    var top_noms_actifs = [];
    var top_noms_poly = []; //on extrait les NB_NOMS les plus actifs

    var noms_actifs = Object.keys(dict_matrix).map(function (key) {
      return [key, dict_matrix[key].nb_part];
    });
    var aux_noms_actifs = noms_actifs.sort(function (e1, e2) {
      return e2[1] - e1[1];
    }).slice(2, NB_NOMS + 2).forEach(function (e) {
      top_noms_actifs.push(e[0]);
    }); //on construit un dict associant à chaque nom id une carrière précisant le nombre de films par roles

    var dict_top_actifs = {};
    top_noms_actifs.forEach(function (nomId) {
      dict_top_actifs[nomId] = {};
      var data_career = dict_noms_car[nomId];
      data_career.forEach(function (c) {
        if (ROLES.includes(c.fonctionCategory)) {
    ...
    var aux_noms_poly = noms_poly.sort(function (e1, e2) {
      if (e2[1] != e1[1]) {
        return e2[1] - e1[1];
      } else {
      ...
      top_noms_poly.push(e[0]);
    });
    ; //on construit un dict associant à chaque nom id une carrière précisant le nombre de films par roles

    var dict_top_poly = {};
    top_noms_poly.forEach(function (nomId) {
      dict_top_poly[nomId] = {};
      var data_career = dict_noms_car[nomId];
      data_career.forEach(function (c) {
        if (ROLES.includes(c.fonctionCategory)) {
    ...
    var _iterator = _createForOfIteratorHelper(Array(NB_NOMS).keys()),
        _step;
    ...
    try {
      var _loop = function _loop() {
        var i = _step.value;
        aux_data.push([]);
        var nomId_top_actif = top_noms_actifs[i];
        var nomId_top_poly = top_noms_poly[i]; //on récupère les noms des top_actif et poly

        var nom_top_actif = dict_nomsId[nomId_top_actif].prenom + ' ' + dict_nomsId[nomId_top_actif].nom;
        var nom_top_poly = dict_nomsId[nomId_top_poly].prenom + ' ' + dict_nomsId[nomId_top_poly].nom;
        ROLES.forEach(function (role) {
          var new_element = {};

          if (role in dict_top_actifs[nomId_top_actif]) {
            new_element['top_actif'] = {
              'nom': nom_top_actif,
              'fonction': role,
              'count': dict_top_actifs[nomId_top_actif][role]
            };
          } else {
            new_element['top_actif'] = {
              'nom': nom_top_actif,
          ...
          if (role in dict_top_poly[nomId_top_poly]) {
            new_element['top_poly'] = {
              'nom': nom_top_poly,
              'fonction': role,
              'count': dict_top_poly[nomId_top_poly][role]
            };
          } else {
            new_element['top_poly'] = {
              'nom': nom_top_poly,
    ...
    setSizingMatrix(); //taille coté des cases dans la matrice

    var cote_case_x = graphSizeMatrix.width / ROLES.length;
    var cote_case_y = graphSizeMatrix.height / NB_NOMS;
    ...
    buildMatrix();
    d3.select('#viz4 .toggle-button').on('click', function () {
      if (MODE == 'top_poly') {
        MODE = 'top_actif';
    ...
    function setSizingMatrix() {
      var graphWidth = Math.min(self.innerWidth, 900);
      var graphHeight = 530;
      svgSizeMatrix = {
        width: graphWidth,
        height: graphHeight
    ...
    function buildMatrix() {
      ...
      if (MODE == 'top_poly') {
        top_noms_poly.map(function (n) {
          return dict_nomsId[n];
        }).forEach(function (c) {
          return noms.push(c.prenom + ' ' + c.nom);
        });
      } else {
        top_noms_actifs.map(function (n) {
          return dict_nomsId[n];
        }).forEach(function (c) {
          return noms.push(c.prenom + ' ' + c.nom);
        });
...
},{"./preprocess.js":"src/preprocess.js","d3-tip":"node_modules/d3-tip/dist/index.js","d3-svg-legend":"node_modules/d3-svg-legend/indexRollupNext.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/viz4.js"], null)
//# sourceMappingURL=/viz4.212204c1.js.map