...
},{"d3-collection":"node_modules/d3-collection/src/index.js","d3-selection":"node_modules/d3-selection/src/index.js"}],"src/viz1.js":[function(require,module,exports) {
'use strict';
...
function generateG(margin) {
  return d3.select('#viz1').select('.waffle-svg').append('g').attr('id', 'waffle-g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
}
/**
...
function setCanvasSizeWaffle(width, height) {
  d3.select('#viz1').select('svg').attr('width', width).attr('height', height);
}
/**
...
(function (d3) {
  ...
  var svgSizeWaffle;
  var graphSizeWaffle;
  var tipWaffle = (0, _d3Tip.default)().attr('class', 'd3-tip').html(function (d) {
    return getContentsWaffle(d);
  });
  d3.select('.waffle-svg').call(tipWaffle);
  var data_noms;
  var data_filmo;
  var data_fonction; //associe nomId aux noms et prénoms
...
},{"./preprocess.js":"src/preprocess.js","d3-tip":"node_modules/d3-tip/dist/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/viz1.js"], null)
//# sourceMappingURL=/viz1.85b6e48c.js.map