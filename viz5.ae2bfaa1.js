...
var _default = index;
exports.default = _default;
},{"d3-selection":"node_modules/d3-svg-legend/node_modules/d3-selection/index.js","d3-format":"node_modules/d3-svg-legend/node_modules/d3-format/index.js","d3-dispatch":"node_modules/d3-svg-legend/node_modules/d3-dispatch/index.js","d3-scale":"node_modules/d3-svg-legend/node_modules/d3-scale/index.js","d3-array":"node_modules/d3-svg-legend/node_modules/d3-array/index.js"}],"src/viz5.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.generateGHistogram = generateGHistogram;
exports.appendAxes = appendAxes;
exports.appendGraphLabels = appendGraphLabels;
exports.setCanvasSizeHistogram = setCanvasSizeHistogram;
...
exports.drawLegendHistogram = drawLegendHistogram;
exports.getContentsHistogram = getContentsHistogram;
...
function generateGHistogram(margin) {
  return d3.select('#viz5').select('.histogram-svg').append('g').attr('id', 'histogram-g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
}
/**
...
function setCanvasSizeHistogram(width, height) {
  d3.select('#viz5').select('svg').attr('width', width).attr('height', height);
}
/**
...
function drawXAxis(xScale, height) {
  d3.select('#viz5 .x.axis').attr('transform', 'translate(0, ' + height + ')').call(d3.axisBottom(xScale).tickFormat(function (x) {
    return String(x);
  }));
}
/**
...
function updateYScale(scale, data_career, height) {
  var dict_year = {};
  var max_roles = 0;
  var found = false;
  data_career.forEach(function (c) {
...
function setColorScale(data_career, dict_fonctionId) {
  //on compte le nombre de rôles différents
  var set_roles = new Set();
  data_career.forEach(function (c) {
    return set_roles.add(c.fonctionCategory);
  });
  var roles = Array.from(set_roles);
  var nbre_roles = roles.length;
  return d3.scaleOrdinal().domain(roles).range(COLORS.slice(0, nbre_roles));
}
/**
 * Draws the histogram
 *
...
function drawHistogram(yScale, xScale, data_career, height, width, colorScale, tip) {
  ...
  function setY(c) {
    //on màj dict_count
    var annee_film = c.film.anneeSortie;
...
function drawLegendHistogram(g, colorScale, width) {
  var offset_x = width + 40;
  g.append("g").attr("class", "legendOrdinal").attr("transform", "translate(" + offset_x + ",20)");

  var legendOrdinal = _d3SvgLegend.default.legendColor().shape("path", d3.symbol().type(d3.symbolCircle).size(200)()).scale(colorScale).title("Légende");
...
function getContentsHistogram(c) {
  var labelTitre = "<div class=\"tooltip-title\">Film : " + c.film.titreOriginal + "</div>";
  var labelFonction = "<div class=\"tooltip-title\">Fonction : " + c.fonction + "</div>";
  return labelTitre + labelFonction;
}

(function (d3) {
  var margin_histogram = {
    top: 80,
    right: 200,
    bottom: 80,
    left: 55
  ...
  var boundsHistogram;
  var svgSizeHistogram;
  var graphSizeHistogram;
  var xScale = d3.scaleLinear();
  var yScale = d3.scaleLinear();
  var tipHistogram = (0, _d3Tip.default)().attr('class', 'd3-tip').html(function (d) {
    return getContentsHistogram(d);
  });
  d3.select('.histogram-svg').call(tipHistogram);
  var colorScale; //associe nomId aux noms et prénoms
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/viz5.js"], null)
//# sourceMappingURL=/viz5.ae2bfaa1.js.map